              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col h-full py-6 px-4 sm:px-6">
                  ...
                  <div className="mt-6 flex flex-col space-y-2">
                    ...
                    <Link
                      href="/kontakt"
                      className="mt-4 w-full inline-flex items-center justify-center rounded-md bg-primary-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                    >
                      Kontakt oss
                    </Link>
                  </div>
